# -*- coding: utf-8 -*-
"""RDA_ALGO_PARALLEL.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fzrjL6Q8nj2hu_FvFE65mdsd0qL4SJYz
"""
...
def RDA(num_agents, max_iter, graph, N_vertices, obj_function, save_conv_graph, alpha, beta, gamma, num_males_frac, UB, LB, N_PROCS=1):
    ...
    # main loop
    with Parallel(n_jobs=N_PROCS, require='sharedmem') as parallel_shared:
      for iter_no in tqdm(range(max_iter)):
          ...
          parallel_shared(delayed(roar_male_deer)(i) for i in range(num_males))
          ...
          def fight_between_malecommander_stags(i):
          ...
          parallel_shared(delayed(fight_between_malecommander_stags)(i) for i in range(num_coms))
          ...
          parallel_shared(delayed(mating_of_command_with_hinds_in_his_harem)(i) for i in range(num_coms))

          # mating of stag with nearest hind
          def mating_of_stags_with_nearest_hind(stag):
          ...
          parallel_shared(delayed(mating_of_stags_with_nearest_hind)(stag) for stag in stags)
